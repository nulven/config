(() => {
    ...
    __webpack_require__.r = exports => {
        ...
        class NetflixChatApi extends class {
            ...
            onChatKeyPress(event) {
                super.onChatKeyPress(event), this._shouldBeFocused = !0, document.querySelector("[data-uia='controls-standard']") && window.postMessage({
                    type: "ShowControls"
                }, "*");
            }
            _injectChat() {
            ...
            setChatVisible(visible) {
                if (super.setChatVisible(visible), visible) {
        ...
        class NetflixVideoEventListener extends class {
            ...
            constructor(videoApi, chatApi) {
                ...
                this._videoApi = videoApi, this._chatApi = chatApi, window.replaceScriptLoaded || (debug("injecting replace script"), 
