    ...
    __webpack_require__.r = exports => {
        ...
        class HboMaxVideoEventListener extends class {
            ...
            constructor(videoApi, chatApi) {
                ...
                HboMaxVideoEventListener_defineProperty(this, "_upNextClicked", !1), HboMaxVideoEventListener_defineProperty(this, "F_KEY_CODE", 70), 
                this._videoApi = videoApi, this._chatApi = chatApi, this._onEpisodeData = this._videoApi.episodeDataInteraction.bind(this._videoApi), 
            ...
            startListening() {
                ...
                playCover && this._coverObserver.observe(playCover, {
                    ...
                    console.log(ev.keyCode), ev.keyCode === this.F_KEY_CODE && (ev.stopImmediatePropagation(), 
                    this.onFullScreen());
                }), !0), document.arrive("[aria-label*='Up Next']", (elem => {
                ...
                if ("FROM_PAGE_POP" !== event.data.type && episodePage) {
                    if (event.data.type && "FROM_PAGE" == event.data.type) {
                        ...
                        this._upNextClicked = !1, this._videoApi.updateVideoId().then((() => {
                            ...
                            var _this$_videoMessageFo8;
                            nextVideoId ? this._onNextEpisode(nextVideoId) : debug("No next episode: " + nextVideoId + " : " + (null === (_this$_videoMessageFo8 = this._videoMessageForwarder) || void 0 === _this$_videoMessageFo8 ? void 0 : _this$_videoMessageFo8.videoId));
                        })).catch((err => {
                            var _this$_videoMessageFo9, _this$_videoMessageFo10;
                            (null === this._videoApi.getVideoElement && this._onTeardown(DEFAULT_TEARDOWN), 
                            debug("Replace failed " + err), this._videoApi.videoId !== (null === (_this$_videoMessageFo9 = this._videoMessageForwarder) || void 0 === _this$_videoMessageFo9 ? void 0 : _this$_videoMessageFo9.videoId)) ? null !== (_this$_videoMessageFo10 = this._videoMessageForwarder) && void 0 !== _this$_videoMessageFo10 && _this$_videoMessageFo10.changingVideo ? this._onTeardown(FAILED_NEXT_EPISODE_DATA) : this._onTeardown(INVALID_NEXT_EPISODE_DATA) : this._videoMessageForwarder && (this._videoMessageForwarder.changingVideo = !1);
                        }));
                    }
        ...
        class HboMaxVideoApi extends class {
            ...
            constructor() {
                ...
                HboMaxVideoApi_defineProperty(this, "_checkVideoDelay", 500), this.videoIds = {}, 
                this.markerUpdatedAt = 0, this.videoTitle = null !== (_this$_getVideoTitle = this._getVideoTitle()) && void 0 !== _this$_getVideoTitle ? _this$_getVideoTitle : "", 
            ...
            async waitVideoApiReadyAsync() {
                await delayUntil((() => (this.removeVideoCover(), null != this.getVideoElement())), 1 / 0, this._checkVideoDelay)(), 
