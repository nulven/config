...
/* harmony import */ var _DevToolsFiberComponentStack__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(62);
...
var react_debug_tools = __webpack_require__(61);
...
function P(a, b, c, e, d) {
  ...
  if (G(a)) for (var g = 0; g < a.length; g++) {
    ...
    var f = e + O(k, g);
    h += P(k, b, c, f, d);
  } else if (f = y(a), "function" === typeof f) for (a = f.call(a), g = 0; !(k = a.next()).done;) k = k.value, f = e + O(k, g++), h += P(k, b, c, f, d);else if ("object" === k) throw b = String(a), Error(z(31, "[object Object]" === b ? "object with keys {" + Object.keys(a).join(", ") + "}" : b));
  return h;
}
...
exports.version = "18.0.0-experimental-5fa4d79b0-20211008";
